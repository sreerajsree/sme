...
<div class="container-main pb-5">
    <div class="row">
        <div class="col-md-9 cat-post">
            <div class="cat-title">
                <h2 class="cat-title mvp-widget-home-title"> <span class="mvp-widget-home-title">{{ ucfirst($chosen_main) }}</span></h2>
            </div>
            <div id="main-data">
            ...
            <div class="d-flex align-items-center mt-4">
                ...
                <button class="loadmore btn" onclick="mainLoadMore();">Load More</button>
            </div>
