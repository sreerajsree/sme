...
class RoleController extends DashboardController
{
    ...
    public function store(RoleRequest $request)
    {
        ...
        return redirect('dashboard/sme/roles')->withSuccessMessage('Role Created Successfully!');
    }
    ...
    public function update(RoleRequest $request, Role $role)
    {
        ...
        return redirect('dashboard/sme/roles')->withSuccessMessage('Role Updated Successfully!');
    }
    ...
    public function destroy(Role $role)
    {
        ...
        return redirect('dashboard/sme/roles')->withSuccessMessage('Role Deleted Successfully!');
    }
}
